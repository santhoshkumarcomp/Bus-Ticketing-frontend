...
function LandingPage({ onNavigate, onLogin, onRegister }) {
  ...
  const handleOperatorLogin = () => {
    ...
    onLogin("operator", "operator"); // Reset login state for operator
    setShowLoginModal(true);
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Book bus tickets instantly or manage your fleet with our
              comprehensive platform. Safe, reliable, and convenient travel
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Experience the future of bus travel with our innovative platform
              designed for both passengers and operators.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Book your tickets in seconds with our streamlined booking
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Enjoy comfortable journeys with verified operators and quality
                service.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Connect to over 200 cities with our extensive network of trusted
                operators.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                All our partner operators are verified and maintain high service
                standards.
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Discover a new way to travel with comfort, convenience, and
                confidence.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Find and book the perfect bus for your journey in just a
                      few clicks.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Get live updates on your booking status and bus location.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Cancel or modify your booking with our flexible policies.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-xl text-gray-600 mb-8">
                Grow your business with our comprehensive operator platform and
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Add, edit, and manage your buses with our intuitive
                      dashboard.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Monitor bookings, revenue, and customer satisfaction in
                      real-time.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Connect with thousands of passengers across our network.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers and operators who trust
            BusBook for their travel needs.
          </p>
      ...
      <footer id="contact" className="bg-gray-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; 2025 BusBook. All rights reserved. | Privacy Policy | Terms
              of Service
            </p>
          </div>
        </div>
